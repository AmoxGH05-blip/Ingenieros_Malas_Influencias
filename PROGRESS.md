...
- [ ] **SCRUM-28** — Configurar proyecto frontend (React + Tailwind + shadcn/ui) y rutas por rol (Responsable: Nieto Guerra Emiliano) — vencida 13-sep
- [ ] **SCRUM-29** — Pantallas de login y recuperación de contraseña (Responsable: Nieto Guerra Emiliano) — vencida 13-sep
